...
class User {
    ...
    public function create($email, $password, $name) {
        try {
            $query = "INSERT INTO {$this->table} (email, password, name, created_at) 
            ...
            throw new Exception("Erro ao criar utilizador: " . $e->getMessage());
        }
    }
    ...
    public function findByEmail($email) {
        try {
            ...
            throw new Exception("Erro ao buscar utilizador: " . $e->getMessage());
        }
    }
